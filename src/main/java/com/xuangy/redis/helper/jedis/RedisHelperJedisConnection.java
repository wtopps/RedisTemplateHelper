 ...
 * @author Mark Paluch
 */
public class RedisHelperJedisConnection extends AbstractRedisConnection {

	private static final Field CLIENT_FIELD;
	private static final Method SEND_COMMAND;
	private static final Method GET_RESPONSE;

	private static final String SHUTDOWN_SCRIPT = "return redisHelper.call('SHUTDOWN','%s')";
	...
	static {
		...
		try {
			Class<?> commandType = ClassUtils.isPresent("redisHelper.clients.jedis.ProtocolCommand", null) ? ClassUtils.forName(
					"redisHelper.clients.jedis.ProtocolCommand", null) : ClassUtils.forName("redisHelper.clients.jedis.Protocol$Command",
					null);
			...
			throw new NoClassDefFoundError(
					"Could not find required flavor of command required by 'redisHelper.clients.jedis.Connection#sendCommand'.");
		}
	...
	/**
	 * Constructs a new <code>RedisHelperJedisConnection</code> instance.
	 *
	 * @param jedis Jedis entity
	 */
	public RedisHelperJedisConnection(Jedis jedis) {
		this(jedis, null, 0);
	}

	/**
	 * Constructs a new <code>RedisHelperJedisConnection</code> instance backed by a jedis pool.
	 *
	 * @param jedis
	 * @param pool can be null, if no pool is used
	 */
	public RedisHelperJedisConnection(Jedis jedis, Pool<Jedis> pool, int dbIndex) {
		this.jedis = jedis;
...
//					}
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.redisHelper.connection.RedisStringCommands#set(byte[], byte[], org.springframework.data.redisHelper.core.types.Expiration, org.springframework.data.redisHelper.connection.RedisStringCommands.SetOption)
	 */
	@Override
	...
	public Long time() {
		...
		Assert.isTrue(serverTimeInformation.size() == 2,
				"Received invalid nr of arguments from redisHelper server. Expected 2 received " + serverTimeInformation.size());
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.redisHelper.connection.RedisServerCommands#killClient(byte[])
	 */
	@Override
	...
	/*
	* @see org.springframework.data.redisHelper.connection.RedisServerCommands#setClientName(java.lang.String)
	*/
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.redisHelper.connection.RedisZSetCommands#zScan(byte[], org.springframework.data.redisHelper.core.ScanOptions)
	 */
	@Override
